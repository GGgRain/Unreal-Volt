...
UVolt_ASA_Disappear::UVolt_ASA_Disappear(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	SlotModule->StartOpacity = 1;
	SlotModule->RateBasedInterpSpeed = 7;
	SlotModule->TargetOpacity = 0;
