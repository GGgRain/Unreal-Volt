...
#include "Volt_ASM_InterpForegroundColor.generated.h"

UCLASS(EditInlineNew, Blueprintable, BlueprintType)
class VOLT_API UVolt_ASM_InterpForegroundColor : public UVoltModuleItem
{
...
public:
	...
	VOLT_MODULE_BEGIN_ARGS(UVolt_ASM_InterpForegroundColor) :
