...
public:
	...
	VOLT_MODULE_BEGIN_ARGS(UVolt_ASM_InterpWidgetTransform) :
		_InterpolationMode(EVoltInterpMode::RateBased),

		_StartWidgetTransform(FWidgetTransform(FVector2D::ZeroVector, FVector2D(1,1), FVector2D(0,0), 0)),
		_bUseStartWidgetTransform(false),
		_TargetWidgetTransform(FWidgetTransform(FVector2D::ZeroVector, FVector2D(1,1), FVector2D(0,0), 0)),
	...
	{}
		...
		VOLT_MODULE_ARGUMENT( FWidgetTransform, StartWidgetTransform )
		VOLT_MODULE_ARGUMENT( bool, bUseStartWidgetTransform )
		VOLT_MODULE_ARGUMENT( FWidgetTransform, TargetWidgetTransform )
