...
public:
	...
	VOLT_MODULE_BEGIN_ARGS(UVolt_ASM_InterpRenderOpacity) :
		_InterpolationMode(EVoltInterpMode::RateBased),
	
		_StartOpacity(0),
		_bUseStartOpacity(false),
		_TargetOpacity(0),
	...
	{}
		...
		VOLT_MODULE_ARGUMENT( float, StartOpacity )
		VOLT_MODULE_ARGUMENT( bool, bUseStartOpacity )
		VOLT_MODULE_ARGUMENT( float, TargetOpacity )
